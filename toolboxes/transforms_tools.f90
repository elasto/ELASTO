...
!!  INTEGER :: nbthreads
  ...
  ! Sizes of the local real array ---> "dimension of the crayon"   
  iarray(1)=input%nx
  ...
  ! LUCA: (15/10/2013)
  ! I try to implement an openmp parallelization
  ! the idea is to distribute the nbfft1d FFTs between
  ! the threads. First methods I choose mod(nbfft1d,num_threads)=0

  !$OMP PARALLEL DEFAULT(PRIVATE)

  ! define nbthreads
!!  nbthreads =  OMP_GET_NUM_THREADS()
!!  print *, 'processor me:', me, 'Along X: nbfft1d, nbthreads, nbfft1d/nbthreads:', nbfft1d, nbthreads, nbfft1d/(nbthreads)
  
  !nbfft1d=(iarray(2)*iarray(3))/(nbthreads)

!!  CALL fftw_plan_with_nthreads(nbthreads)
  ...
  !first use a temp array to rorganize datas with contiguous position along Y
  ...
  ! define nbthreads
  nbthreads =  OMP_GET_NUM_THREADS()
  print *, 'processor me:', me, 'Along Y nbfft1d, nbthreads, number of fft1d per thread:', nbfft1d, nbthreads, nbfft1d/(nbthreads)
  !nbfft1d=(iarray(2)*iarray(3))/(nbthreads)
  ...
  ! define nbthreads
  nbthreads =  OMP_GET_NUM_THREADS()
  print *, 'processor me:', me, 'Along Z nbfft1d, nbthreads, nbfft1d/nbthreads:', nbfft1d, nbthreads, nbfft1d/(nbthreads)
  !nbfft1d=(iarray(2)*iarray(3))/(nbthreads)
