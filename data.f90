...
!------------------------------------------------------------------------------
!=========================================================================================!
LOGICAL FUNCTION data_init_luca(ncpus,spec_rank,mult,sigma,sigma_old,Esigma,Lsigma,G,sigmak,n_activ,convol)
!=========================================================================================!
    USE datalayout
    USE param
    USE cart_topology
    ...
    TYPE(REAL_DATA_LAYOUT),INTENT(INOUT)        :: sigma,sigma_old,mult
